...
public class ShoppingStoreServiceImpl implements ShoppingStoreService {
    ...
    public ProductDto updateProduct(ProductDto productDto) {
        ...
        Product existingProduct = ifProductExistedInDb(productId);
    ...
    public boolean removeProductFromStore(UUID productId) {
        ...
        Product product = ifProductExistedInDb(productId);
    ...
    public boolean setProductQuantityState(SetProductQuantityStateRequest request) {
        ...
        Product product = ifProductExistedInDb(request.getProductId());
    ...
    private Product ifProductExistedInDb(UUID productId) {
